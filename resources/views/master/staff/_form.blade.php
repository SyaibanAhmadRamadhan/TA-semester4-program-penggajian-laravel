<div class="card-body">
    ...
    <div class="form-group row">
        ...
        <div class="col-12 col-md-5 col-lg-5">
            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                value="{{ old('name', $staff->name ?? '') }}" placeholder="Nama lengkap.." autocomplete="off">
            @error('name')
    ...
    <div class="form-group row">
        <label class="col-md-4 col-xs-4 col-form-label justify-flex-end">Tgl. lahir <span
                class="text-danger">*</span></label>
        <div class="col-12 col-md-5 col-lg-5">
            <input type="date" name="birth" class="form-control @error('birth') is-invalid @enderror"
                value="{{ old('birth', $staff->birth ?? '') }}" autocomplete="off">
            @error('birth')
                <span class="invalid-feedback" role="alert">
    ...
    <div class="form-group row">
        <label class="col-md-4 col-xs-4 col-form-label justify-flex-end">Tgl. Mulai Kerja <span
                class="text-danger">*</span></label>
        <div class="col-12 col-md-5 col-lg-5">
            <input type="date" name="startdate" class="form-control @error('startdate') is-invalid @enderror"
                value="{{ old('startdate', $staff->startdate ?? '') }}" autocomplete="off">
            @error('startdate')
                <span class="invalid-feedback" role="alert">
    ...
    <div class="form-group row">
        <label class="col-md-4 col-xs-4 col-form-label justify-flex-end">No. Telp <span
                class="text-danger">*</span></label>
        <div class="col-12 col-md-5 col-lg-5">
            <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror"
                value="{{ old('phone', $staff->phone ?? '') }}" placeholder="0823..."
    ...
    <div class="form-group row">
        <label class="col-md-4 col-xs-4 col-form-label justify-flex-end">Position <span
                class="text-danger">*</span></label>
        <div class="col-12 col-md-5 col-lg-5">
            <select name="position_id" class="form-control select2 @error('position_id') is-invalid @enderror">
                ...
                @foreach ($position as $item)
                    <option value="{{ $item->id }}"
                        {{ $item->id == old('position_id', $staff->position_id ?? '') ? 'selected' : '' }}>
                        {{ $item->name }}</option>
                @endforeach
            </select>
            @error('position_id')
        ...
        <div class="col-12 col-md-5 col-lg-5">
            <select name="departement_id" class="form-control select2 @error('departement_id') is-invalid @enderror">
                ...
                @foreach ($departement as $item)
                    <option value="{{ $item->id }}"
                        {{ $item->id == old('departement_id', $staff->departement_id ?? '') ? 'selected' : '' }}>
                        {{ $item->name }}</option>
                @endforeach
            </select>
    ...
    @if (!isset($staff->users_id))
        {{-- <div class="form-group row">
            <div class="col-12 col-md-5 col-lg-5 offset-md-4">
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="makeUserAccount" value="true"
                            {{ old('makeUserAccount') ? 'checked' : '' }} class="toggle-form-user"> Buat akun user
                        untuk karyawan ini.
                    </label>
                </div>
            </div>
    ...
    <div id="form-user" style="display: none">
        <hr>
        <div class="form-group row">
            <label class="col-md-4 col-xs-4 col-form-label justify-flex-end">Username <span
                    class="text-red">*</span></label>
            <div class="col-12 col-md-5 col-lg-5">
                <input type="text" name="username" class="form-control @error('username') is-invalid @enderror"
                    value="{{ old('username') ?? '' }}" placeholder="Masukan username.." disabled>
                @error('username')
                    <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group row">
            <label class="col-md-4 col-xs-4 col-form-label justify-flex-end">Password <span
                    class="text-red">*</span></label>
            <div class="col-12 col-md-5 col-lg-5">
        ...
        <div class="form-group row">
            <label class="col-md-4 col-xs-4 col-form-label justify-flex-end">Level User <span
                    class="text-red">*</span></label>
            <div class="col-12 col-md-5 col-lg-5">
                @foreach ($roles as $role)
                    <label class="radio-inline">
                        <input type="radio" name="role_id" value="{{ $role->id }}"
                            {{ old('role_id') == $role->id ? 'checked' : '' }} disabled>
