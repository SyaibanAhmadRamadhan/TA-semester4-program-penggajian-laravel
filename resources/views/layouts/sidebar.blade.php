<aside class="main-sidebar sidebar-light-primary elevation-4">
    <a href="{{ route('home') }}" class="brand-link bg-primary">
        {{-- <img src="{{ asset('img/logo-2.jpeg') }}" alt="Logo" class="brand-image img-circle elevation-3"
            style="opacity: .8"> --}}
        <span class="brand-text font-weight-light">Program penggajian</span>
    </a>

    <div class="sidebar">
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="{{ asset(Auth::user()->staff->photo ?? 'img/user.jpg') }}" class="img-circle elevation-2"
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('master.position.index') }}"
                                    class="nav-link {{ $sub == 'position' ? 'active' : '' }}">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('master.departement.index') }}"
                                    class="nav-link {{ $sub == 'departement' ? 'active' : '' }}">
                                    <i class="nav-icon fa fa-circle-o"></i>
                                    <p>Departement</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('master.staff.index') }}"
                                    class="nav-link {{ $sub == 'staff' ? 'active' : '' }}">
                                    <i class="nav-icon fa fa-circle-o"></i>
                                    <p>Staff</p>
                                </a>
                            </li>
